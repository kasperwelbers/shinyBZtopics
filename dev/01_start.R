...
golem::fill_desc(
  pkg_name = "shinyBZtopics", # The Name of the package containing the App 
  pkg_title = "Topic modeling shiny app", # The Title of the package containing the App 
  pkg_description = "A shiny app for a topic browser.", # The Description of the package containing the App 
  ...
  repo_url = 'https://github.com/kasperwelbers/shinyBZtopics' # The (optional) URL of the GitHub Repo
)     
